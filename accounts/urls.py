...
from .views import (
    ...
    RestorePasswordView, RestorePasswordDoneView, RestorePasswordConfirmView,Request_list, detail, UpdateRequest,
    NewRequest
)
...
urlpatterns = [
    ...
    path('typerequests/',Request_list,name="type_Request"),
